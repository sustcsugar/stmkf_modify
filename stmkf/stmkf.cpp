/*
STMKF - A Real-Time Spatio-Temporal V¨ªdeo Denoising Method with Kalman-based and Bilateral Filters Fusion
...
STMKF::STMKF(Mat firstFrame, float q, float r, int maskSize, int d, double sigmaValue) {
	int height = firstFrame.rows;//¸ü¸Ä
...
Mat STMKF::newFrame(Mat frame) {
	...
	fastNlMeansDenoising(floatFrame, bfFrame, d, sigmas, sigmas);
